...
if ($_GET['action'] == 'delete') {
    $vid = intval($_GET['vid']);
    $query = mysqli_query($con, "delete from vehicle where vid='$vid'");
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">ADMIN | Vehicle Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center no-print">
                                            ...
                                            <a href="edit-vehicle.php?vid=<?php echo $row['vid']; ?>">
                                                <i class="fas fa-edit" style="color:blue"></i>
                                            </a>&nbsp;|&nbsp;

                                            <a href="manage-vehicle.php?vid=<?php echo $row['vid']; ?>&&action=delete"
