...
if ($_GET['action'] == 'delete') {
    ...
    $query = mysqli_query($con, "delete from driver where drid='$drid'");
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">ADMIN | Driver Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                            ...
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['DrvLcNo']; ?></td>
                                        <td><?php echo $row['VehicleRegNo']; ?></td>
                                        <td><a href="mailto:<?= $row['Email']; ?>"><?php echo $row['Email']; ?></a></td>
                                        <td><?php echo $row['Availability']; ?></td>
                                        <td class="text-center no-print">

                                            <a href="edit-driver.php?drid=<?php echo $row['drid']; ?>">
                                                <i class="fas fa-edit" style="color:blue"></i>
                                            </a>&nbsp;|&nbsp;

                                            <a href="manage-driver.php?drid=<?php echo $row['drid']; ?>&&action=delete"
