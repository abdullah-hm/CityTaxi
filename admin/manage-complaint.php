    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ADMIN | Complaint Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="edit-complaint.php?cid=<?php echo $row['cid']; ?>">
                                <i class="fas fa-edit" style="color:blue"></i>
                            </a>&nbsp;|&nbsp;

                            <a href="manage-complaint.php?cid=<?php echo $row['cid']; ?>&&action=delete"
