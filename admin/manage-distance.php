...
if ($_GET['action'] == 'delete') {
    ...
    $query = mysqli_query($con, "delete from distance where dsid='$dsid'");
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Admin | Location Distance Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="card col-lg-12 col-sm-12">
                        <div class="card-header ">
                            <h3>List of All Location Distance
                        ...
                        <div class="card-body">
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                $query = mysqli_query($con, "select * from distance");
                                $cnt = 1;
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center no-print">
                                            <a href="edit-distance.php?dsid=<?php echo $row['dsid']; ?>">
                                                <i class="fas fa-edit" style="color:blue"></i>
                                            </a>&nbsp;|&nbsp;

                                            <a href="manage-distance.php?dsid=<?php echo $row['dsid']; ?>&&action=delete"
