    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">DRIVER | Completed Trip Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="card col-lg-12 col-sm-12">
                        <div class="card-header ">
                            <h3 style="color:blue">List of Completed Trips
                        ...
                        <div class="card-body">
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                $query = mysqli_query($con, "select * from booking where drid='$drid' and Status='Completed' ");
                                $cnt = 1;
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>Rs <?php echo  (0.8 * $row['Amount']); ?></td>
