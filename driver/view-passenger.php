    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">DRIVER | View Passenger Details</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="dashboard.php">Passenger</a></li>
                    ...
                    <div class="card col-lg-12 col-sm-12">
                        ...
                        <div class="card-body">
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                $query = mysqli_query($con, "select * from passenger where pid='$vp'");
                                $cnt = 1;
